...
var createTarFromFolder = function( dir ) {
    ...
    var req = request.post( route.host + ':' + route.port + '/' + route.path );
    req.type("binary");
...
//            return;
//        }
//        console.log('---- there was a successful end call');
//    });
...
//                console.log( e );
//            });
//        .pipe( buf )                // Pipe into a buffer that converts it to binary (probably is binary already)
//            .on( 'end', function( e ) {
//                console.log( 'buffered I up' );
