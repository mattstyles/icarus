...
module.exports = (function() {
    ...
    var getGithubAuth = function() {
        ...
        var repo = pkg.repository.url.match( /[^\/]+$/ )[0],
            ...
            client_id = '',
            client_secret = '',
            url = 'https://' + path.join( 'api.github.com', 'authorizations', 'clients', client_id );
        ...
        icarus.log.debug( 'Attempting to authenticate with github'.info );
        request.put( authRequest, onAuth );
